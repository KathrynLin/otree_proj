...
class Constants(BaseConstants):
    name_in_url = 'quiz_high_four'
    players_per_group = None
    num_rounds = 1
    point_per_correct = c(1.6)
    endowment = c(10)
    # correct answer for pre-test
    question11_correct = c(14.53)
    question12_correct = c(9)
    question13_correct = c(23.53)
    question21_correct = c(46.15)
    question22_correct = c(5)
    question23_correct = c(51.15)
    question31_correct = c(54.55)
    question32_correct = c(0)
    question33_correct = c(54.55)
    question4_correct = c(4)
    question5_correct = c(2)
